...
// Returns the private 'App\Repository\TextContratRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TextContratRepository.php';

return $this->privates['App\Repository\TextContratRepository'] = new \App\Repository\TextContratRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

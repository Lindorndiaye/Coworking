...
$h->addLoader(new \FOS\RestBundle\Routing\Loader\RestRouteLoader($this, $d, $c, new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($b, new \FOS\RestBundle\Request\ParamReader($b), new \FOS\RestBundle\Inflector\DoctrineInflector(), true, array('json' => false, 'xml' => false, 'html' => true), true), $b), NULL));
$h->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($d, $f, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$h->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($d, $f, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$h->addLoader($g);

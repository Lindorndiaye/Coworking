...
// Returns the private 'App\Repository\LocaliteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LocaliteRepository.php';

return $this->privates['App\Repository\LocaliteRepository'] = new \App\Repository\LocaliteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
